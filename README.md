...
Awesome, feature-rich, fast, easy to use and plugable JavaScript web player - version v5.1.1.

This is the compiled free version of Meisterplayer, called `Meister Woodstock`. It's free to be used in non-commercial websites. If you just want a lean-mean and simple to implement videoplayer for your website; *this is it*. 

We also offer a Wordpress-plugin, so if you are running your website on Wordpress, head over to [https://wordpress.org/plugins/meister-player/](https://wordpress.org/plugins/meister-player/) to download it, or search from `wp-admin->plugins->add new plugin`. Check out the installation guide for more information : [https://wordpress.org/plugins/meister-player/#installation](https://wordpress.org/plugins/meister-player/#installation). 
...
- Upload the file `meister.bundled.min.js` somewhere using the tools you're acquainted to.  
- Add a script-tag in the head of your HTML, eg;

``` html
<script src="js/meister.bundled.min.js">
```

- Initialise and configure the player
...
<html>
    <head>
        ...
        <script src="js/meister.bundled.min.js"></script>
    </head>
    <body>
        <div id="player"></div>
        <script>
...
Meisterplayer has 2 kinds of configuration; `global` and plugin-configuration. The global configuration are options that are very generic and often used. For an overview of all the global-configuration options, check out `Global Configuration`. 

#### Plugin configuration ####
Each plugin in Meisterplayer can have it's own configuration. This configuration is added when constructing the instance like this;

```
	 	   var meisterPlayer = new Meister('#meister', {
				global: {
             		autoplay: true,
            	},
            	standard: {
...
This example has some configuration for plugins called `standard` and `chromecaseSender`. `global` is not a plugin, that's the global configuration as described earlier.

Meister Woodstock has the following plugins, refer to their documentation for all the configuration options;
...
- [DASH support for Meister](https://github.com/meisterplayer/media-dash) (This is the plugin which allows playback of DASH streams)
- [Debug overlay for Meister](https://github.com/meisterplayer/ui-debugoverlay) (This is a UI plugin to show debug information)
- [HTML UI Template engine for Meister](https://github.com/meisterplayer/ui-htmlui) (This is the brand new UI templating engine)
- [Multisource plugin for Meister](https://github.com/meisterplayer/parser-multisource) (Allows Meister to play different formats of the same video with fallback)
- [HLS for Meister](https://github.com/meisterplayer/media-hls) (Takes care of HLS streams)
- [Native HLS for Meister](https://github.com/meisterplayer/media-nativehls) (Takes care of HLS streams on devices that support HLS natively (iOS, Mac))
- [Smooth playback for Meister](https://github.com/meisterplayer/media-smooth) (This plugin adds support for Smooth-streaming)
- [Watermark plugin for Meister](https://github.com/meisterplayer/ui-watermark) (Allows you to overlay a watermark on your video's, very fancy!)
- [WebVTT for Meister](https://github.com/meisterplayer/parser-webvtt) (Adds support for WebVTT subtitles)
- [Youtube for Meister](https://github.com/meisterplayer/media-youtube) (This plugin will add support for embedding Youtube video's)
...
If you are developing your website with NPM and you would like to use Meister as a NPM module, head over to the [GitHub page](https://github.com/meisterplayer/meisterplayer) of Meister-core and check out the [readme](https://github.com/meisterplayer/meisterplayer/blob/develop/README.md). 
We also have a so called `Meister Woodstock Target` ready to be cloned to get up & running quickly. Check it out on [GitHub](https://github.com/meisterplayer/meister-woodstock-target-template)
